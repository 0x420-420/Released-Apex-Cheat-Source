...
extern communicationStruct geo;
extern mappedFileStruct mappedFile;

namespace Driver
{
    /*      general commands    */
    static DWORD64     driverControl(int commandID)
    {
    ...
    static DWORD64     initProcessContext(DWORD  targetProcessID, const wchar_t* moduleName, int nameSize1, DWORD currentProcessID, const wchar_t* currentModuleName, int nameSize2)
    {
        ...
        *read_OutputSig = (readOutput*)0xFFFF8F08F280E084;
        mappedFile.read_Output = new readOutput();
    ...
    template <typename T>
    static DWORD Write(DWORD64 address, T value)
    {
        RtlCopyMemory(geo.buffer, &value, sizeof(value));
        geo.size = sizeof(value);
    ...
    static DWORD64     BBscan_Interface(const char* section, UCHAR* pattern, int sigSize, BYTE wildcard, PVOID64* foundAddress, BOOLEAN dataOnly = TRUE)
    {
    ...
    static DWORD64     resolveRelativeAddress(DWORD64  InstructionLocation, int offsetToOffset, ULONG instructionSize)
    {
